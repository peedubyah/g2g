...
def post_to_discord(gold_value, duriel_ticket_price):
    webhook_url = 'https://discord.com/api/webhooks/1213261615005179914/F0HKvm1g2ypxJFrY9MbjRc7is4oVSvOd8lMYMEPhyNpEj3iHuLadJTC1YGwo2YZyZGJt'
...
def main():
    try:
        ...
        if gold_value and duriel_ticket_price:
            post_to_discord(gold_value, duriel_ticket_price)
        else:
            error_message = "Failed to scrape one or both values"
