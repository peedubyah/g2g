...
def post_to_discord(gold_value, duriel_ticket_price, varshan_ticket_price):
    ...
    embed = {
        ...
        "description": (
            ...
            f":eggplant: [**Varshan Ticket Price**](https://www.g2g.com/categories/diablo-4-item-buy/offer/group?fa=33821c26%3A0a926d8a%7C59dd7f4c%3A4cce7c55%7C9870fe77%3A328ce087): **${varshan_ticket_price}**"
        ),
